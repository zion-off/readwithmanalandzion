...
if (matchUrlDomain(change_headers, details.url) && !ignore_types.includes(details.type)) {
  ...
  requestHeaders = requestHeaders.map(function (requestHeader) {
    ...
    if (requestHeader.name === 'User-Agent') {
      useUserAgentMobile = (requestHeader.value.toLowerCase().includes("mobile") || matchUrlDomain(au_news_corp_domains, details.url)) && !matchUrlDomain(['theatlantic.com'], details.url);
    }
