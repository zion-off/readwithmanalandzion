var defaultSites = {
  ...
  "Telegraaf": {
    domain: "telegraaf.nl",
    remove_cookies_select_drop: ["tlgClientId"],
    cs_dompurify: 1
  },
  "Tes Magazine": {
    domain: "tes.com",
  ...
  "The Economist (no podcasts+; fetch from archive.is)": {
...
var de_rp_aachen_medien_nofix_domains = ['aachener-nachrichten.de', 'aachener-zeitung.de', 'saarbruecker-zeitung.de', 'volksfreund.de'];
